...
const AdminTutorials = () => {
            ...
            .then(response => {
                ...
                if (tutorials && tutorials.length > 0) {
                    setTutorials(prevTutorials => {
                        const newTutorials = tutorials.filter(tutorial => !prevTutorials.some(t => t.url === tutorial.url));
    ...
    return (
        <div className="p-6">
            <h1 className="text-center text-2xl font-semibold">Manipulate tutorials</h1>
