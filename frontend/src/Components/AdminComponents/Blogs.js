      ...
      <div className="blogSection p-3">

        {
          loadedBlogs.map(blog => (
            <div key={blog.id} className='p-5 dark:text-white dark:bg-slate-800 bg-gray-100 my-3 shadow-sm rounded-md md:flex md:justify-between'>
              ...
              <div className="buttons flex">
                <Link to='/kubari/admin/'> <PencilSquareIcon className='size-9 text-slate-500 cursor-pointer' /></Link>
                <Link to='/kubari/admin/'> <TrashIcon className='size-9 text-slate-500 cursor-pointer' /></Link>
              </div>
            </div>
          ))
        }
